...
# Tổng quan dự án
Dự án tập trung phân tích và tối ưu hệ thống quản lý kho cho cửa hàng Bách Hóa Xanh.
Các nghiệp vụ chính:
- Quản lý nhập kho
- Quản lý xuất kho
- Kiểm kê tồn kho
...
[BPMN](https://github.com/ThuyLinh24102005/bach-hoa-xanh-inventory-analysis/tree/main/diagrams/BPMN)

# Nội dung thực hiện
- Xây dựng BPMN, DFD, Use Case, ERD
- Tối ưu quy trình quản lý kho
- Xây dựng hệ thống quản lý kho cho cửa hàng
---
# Tài liệu đầy đủ
Google Drive: https://drive.google.com/file/d/1M4DohiutyOr0aFzgnvrKZNi8_8Dcntdw/view?usp=sharing
